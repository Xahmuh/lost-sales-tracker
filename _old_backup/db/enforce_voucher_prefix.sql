-- ==========================================================
-- ANTIGRAVITY PATCH: ENFORCE VOUCHER CODE PREFIX
-- ==========================================================

-- Redefine the transaction function to strictly enforce VOUCH- prefix
...
BEGIN
    ...
    -- Safety check: ensure loop if collision (extremely rare but good practice)
