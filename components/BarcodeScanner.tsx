      ...
      <div className="max-w-xl w-full flex flex-col items-center">
        <div className="w-full flex justify-between items-center mb-8">
          <div className="flex items-center space-x-3 text-white">
            <div className="w-10 h-10 bg-[#8B0000] rounded-xl flex items-center justify-center shadow-lg shadow-[#8B0000]/20">
          ...
          {error ? (
            ...
            <>
              ...
              <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                ...
                <div className="w-64 h-40 border-2 border-[#8B0000]/50 rounded-2xl relative">
                  <div className="absolute top-0 left-0 w-8 h-8 border-t-4 border-l-4 border-[#8B0000] rounded-tl-xl -translate-x-1 -translate-y-1"></div>
                  <div className="absolute top-0 right-0 w-8 h-8 border-t-4 border-r-4 border-[#8B0000] rounded-tr-xl translate-x-1 -translate-y-1"></div>
                  <div className="absolute bottom-0 left-0 w-8 h-8 border-b-4 border-l-4 border-[#8B0000] rounded-bl-xl -translate-x-1 translate-y-1"></div>
                  <div className="absolute bottom-0 right-0 w-8 h-8 border-b-4 border-r-4 border-[#8B0000] rounded-br-xl translate-x-1 translate-y-1"></div>
                  {/* Scanning Animation Line */}
                  <div className="absolute top-0 left-0 w-full h-0.5 bg-[#8B0000]/80 shadow-[0_0_15px_rgba(139,0,0,0.8)] animate-scan-line"></div>
                </div>
              </div>
