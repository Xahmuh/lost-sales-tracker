            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl font-black text-slate-900 mb-3 tracking-tighter">Generate QR & Link</h3>
                ...
                >
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl font-black text-white mb-3 tracking-tighter">Redeem Vouchers</h3>
                        <p className="text-white/40 font-medium text-base leading-relaxed">Verify unique security codes and authorize customer prize redemptions in the database.</p>
                    </div>
                    <div className="flex items-center space-x-3 relative z-10">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl font-black text-slate-900 mb-3 tracking-tighter uppercase leading-none"> Spin & Win dashboard </h3>
                        <p className="text-slate-500 font-medium text-base leading-relaxed opacity-80">Track today's engagement metrics, prizes claimed, and customer activity logs for this node.</p>
                    </div>
                    <div className="flex items-center space-x-3 relative z-10">
