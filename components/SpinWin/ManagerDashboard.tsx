        ...
        <div className={`p-8 rounded-[2rem] border shadow-sm transition-all duration-500 relative flex flex-col justify-between min-h-[180px] ${isPrimary
            ...
            <div className={`flex items-start justify-between relative z-10 ${critical ? 'mt-4' : ''}`}>
                <div>
                    ...
                    {description && (
                        <p className="mt-1 text-[11px] font-bold leading-tight" style={{ color: isPrimary ? '#fff' : '#1f161b' }}>
                            "{description}"
                        </p>
                    )}
                </div>
...
export const ManagerDashboard: React.FC<ManagerDashboardProps> = ({ onBack }) => {
    ...
    return (
        <div className="max-w-[1600px] mx-auto p-4 lg:p-10 animate-in fade-in duration-700 relative">
            {/* Notification Toast */}
            {notification && (
                <div className={`fixed top-6 right-6 z-[200] px-6 py-4 rounded-2xl shadow-2xl flex items-center space-x-3 animate-in slide-in-from-right-10 duration-500 border-l-4 ${notification.type === 'success'
                    ...
                    <button onClick={() => setNotification(null)} className="ml-4 text-slate-300 hover:text-slate-900">
                        <X size={14} />
                    </button>
                </div>
            )}
            ...
            <div className="flex flex-col lg:flex-row gap-10">
                ...
                <aside className="lg:w-80 space-y-6">
                    ...
                    <nav className="bg-white/80 backdrop-blur-xl rounded-[3rem] border border-slate-100 p-4 space-y-2 shadow-xl shadow-slate-200/50 sticky top-32">
                        {[
                            ...
                            <button
                                ...
                                className={`w-full flex items-center space-x-4 px-6 py-5 rounded-[2rem] font-black text-[10px] uppercase tracking-widest transition-all duration-500 ${activeView === item.id
                ...
                <div className="flex-1 space-y-10">
                    ...
                    {activeView === 'analytics' && (
                        <div className="space-y-12 animate-in slide-in-from-bottom-8 duration-1000">
                            ...
                            <section className="bg-white rounded-[2.8rem] border border-slate-100 shadow-sm overflow-hidden p-8 md:p-12 relative group">
                                <div className="flex items-center justify-between mb-10">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <button onClick={() => setLeaderboardPage(p => Math.max(1, p - 1))} className="p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-slate-900 hover:text-white transition-all shadow-sm">
                                            <ChevronLeft size={18} />
                                        </button>
                                        ...
                                        <button onClick={() => setLeaderboardPage(p => Math.min(Math.ceil(metrics.topTraffic.length / 5), p + 1))} className="p-3 bg-slate-50 text-slate-400 rounded-xl hover:bg-slate-900 hover:text-white transition-all shadow-sm">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                                ...
                                <div className="lg:col-span-3 bg-slate-900 rounded-[4rem] p-16 text-white relative overflow-hidden shadow-2xl">
                    ...
                    {activeView === 'prizes' && (
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {prizes.map((prize) => (
                                    <div key={prize.id} className="bg-white p-8 rounded-[3rem] border border-slate-100 shadow-sm group hover:shadow-2xl transition-all duration-700 relative overflow-hidden">
                                            ...
                                            <>
                                                <div className="flex items-start justify-between mb-8 relative z-20">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <button onClick={() => startEditing(prize)} className="p-3 text-slate-400 hover:text-slate-900 transition-all bg-slate-50 rounded-xl hover:bg-slate-100">
                                                            <Edit2 className="w-4 h-4" />
                                                        </button>
                                                        <button onClick={() => handleDeletePrize(prize.id)} className="p-3 text-slate-300 hover:text-red-600 transition-all bg-slate-50 rounded-xl hover:bg-red-50">
                        ...
                        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                {branches.filter(b => b.role === 'branch').map((b) => (
                                    <div key={b.id} className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm flex flex-col lg:flex-row items-center justify-between gap-10 group hover:shadow-xl transition-all duration-700">
