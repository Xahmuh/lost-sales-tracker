-- ==========================================================
-- ANTIGRAVITY PATCH: FIX AMBIGUOUS VOUCHER_CODE REFERENCE
-- ==========================================================
...
DECLARE
    ...
    v_local_voucher_code TEXT; -- Renamed variable to avoid any name collision
...
BEGIN
    ...
    -- 3. Select Prize (Strict Aliasing Applied)
    ...
    -- 7. Return Results
    -- Explicitly return values, do not rely on variable names matching column names automatically
    RETURN QUERY SELECT 
        spin_id, 
        v_local_voucher_code, -- Returns as 'voucher_code' column defined in output TABLE
        v_prize_id, 
        v_prize_record.name, 
