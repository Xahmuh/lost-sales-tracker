                            ...
                            <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100">
                                <div className="space-y-6">
                                    <div className="space-y-4">
                                        <label className={`text-xs font-bold text-slate-900 uppercase tracking-widest block ${isRtl ? 'text-right' : ''}`}>{t.cpr_label}</label>
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className="block w-full h-16 pl-14 pr-5 bg-slate-50 border border-slate-200 rounded-2xl text-lg font-bold text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-brand/10 focus:border-brand transition-all"
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {formData.docTypes.includes('Salary Certificate') && (
                                            <div className="mt-4 animate-in zoom-in-95 duration-500">
                                                <label className="text-sm font-bold text-slate-700 px-1 flex items-center gap-1 mb-2">
                                ...
                                <div className="space-y-8 animate-in slide-in-from-right-12 duration-700">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <button
                                                ...
                                                className={`p-5 rounded-2xl border transition-all flex items-center gap-5 text-left group ${formData.delivery === 'PDF by Email' ? 'bg-white border-blue-500 shadow-lg shadow-blue-500/10 ring-1 ring-blue-500' : 'bg-white border-slate-200 hover:border-blue-400/50'}`}
                                            >
                                                <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center shrink-0 text-blue-500 transition-colors group-hover:bg-blue-100">
                                                    <Mail className="w-6 h-6" />
                                                </div>
                                                <div>
                                                    <h4 className="font-bold text-slate-900 text-sm mb-0.5">{t.card_email_title}</h4>
                                                    <p className="text-xs text-slate-400 font-medium">{t.card_email_desc}</p>
                                                </div>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className={`p-5 rounded-2xl border transition-all flex items-center gap-5 text-left group ${formData.delivery === 'Printed Copy' ? 'bg-white border-orange-500 shadow-lg shadow-orange-500/10 ring-1 ring-orange-500' : 'bg-white border-slate-200 hover:border-orange-400/50'}`}
                                            >
                                                <div className="w-12 h-12 rounded-full bg-orange-50 flex items-center justify-center shrink-0 text-orange-500 transition-colors group-hover:bg-orange-100">
                                                    <Printer className="w-6 h-6" />
                                                </div>
                                                <div>
                                                    <h4 className="font-bold text-slate-900 text-sm mb-0.5">{t.card_print_title}</h4>
                                                    <p className="text-xs text-slate-400 font-medium">{t.card_print_desc}</p>
                                                </div>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div
                                            ...
                                            className="border-2 border-dashed border-slate-200 rounded-2xl py-12 flex flex-col items-center justify-center bg-white hover:bg-slate-50 transition-all cursor-pointer group"
                                        >
                                            <div className="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center mb-4 text-red-500 group-hover:scale-110 transition-transform">
                                                <UploadCloud className="w-6 h-6" />
                                            </div>
                                            <p className="text-sm font-bold text-red-500 mb-1">{t.click_upload}</p>
                                            <p className="text-xs text-slate-400 font-medium">PDF, PNG, JPG (Max 5MB)</p>
                                            ...
                                            <div className="space-y-2">
                                                {uploadedFiles.map((f, i) => (
                                                    <div key={i} className="bg-white border border-slate-100 p-3 rounded-xl flex items-center justify-between group shadow-sm">
                                                        ...
                                                        <button type="button" onClick={() => setUploadedFiles(uploadedFiles.filter((_, idx) => idx !== i))} className="text-rose-500 hover:bg-rose-50 p-2 rounded-lg transition-all"><Trash2 className="w-4 h-4" /></button>
                                                    </div>
                                                ))}
                                            </div>
                                        )}
