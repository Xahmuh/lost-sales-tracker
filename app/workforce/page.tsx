        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700" dir="auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    {regions.map((region) => (
                        <div key={region.id} className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-md transition-all group">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        {/* Metric 2 */}
                        <div className="bg-emerald-500 text-white p-6 rounded-[2rem] relative overflow-hidden group shadow-xl shadow-emerald-500/20">
                        ...
                        <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm relative overflow-hidden group">
                            <div className="absolute top-0 end-0 w-32 h-32 bg-slate-50 rounded-full -me-16 -mt-16 group-hover:scale-150 transition-transform duration-700"></div>
                            <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {/* Ramadan Section */}
                        {includeRamadan && (
                            <div className="bg-amber-50 p-6 rounded-[2rem] border border-amber-100 md:col-span-2">
                                <div className="flex items-center justify-between mb-6">
